...
const tectonicPlatesDataUrl = "Dependencies/Geospatial Files/PB2002_boundaries.json"; // local GeoJSON file
...
let referenceMap = L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png", {
    attribution: "&copy; <a href='https://www.openstreetmap.org/copyright'>OpenStreetMap</a> contributors"
});

let topographicalMap = L.tileLayer("https://{s}.tile.opentopomap.org/{z}/{x}/{y}.png", {
    attribution: "Map data: &copy; <a href='https://www.openstreetmap.org/copyright'>OpenStreetMap</a> contributors"
});

// Add the reference map as the default base map
referenceMap.addTo(map);

// Create the baseMaps object to hold the different base maps
let baseMaps = {
    "Reference": referenceMap,
    "Topographical": topographicalMap
};
